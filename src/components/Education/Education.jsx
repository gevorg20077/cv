      ...
      <div className="education__works">
        ...
        <div className="education__abouts">
          <div className={`education__about ${isAddActive1 ? 'education__about_active' : ''}`}>
            <p className='education__about_header'>Polytech high school</p>
          ...
          <div className={`education__about ${isAddActive2 ? 'education__about_active' : ''}`}>
            <p className='education__about_header'>Smart Code</p>
          ...
          <div className={`education__circle education__circle_1 ${isAddActive1 ? 'education__circle_active1' : ''}`}></div>
          <div className={`education__circle education__circle_2 ${isAddActive2 ? 'education__circle_active2' : ''}`}></div>
        </div>
      </div>
    </div>
  )
